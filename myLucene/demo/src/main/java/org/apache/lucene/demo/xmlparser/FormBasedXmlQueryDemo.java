 ...
 * <p>
 * NOTE: you must provide CSV data in <code>/WEB-INF/data.tsv</code> for the
 * demo to work!
 */
public class FormBasedXmlQueryDemo extends HttpServlet {
	...
	private Analyzer analyzer = new StandardAnalyzer(org.apache.lucene.util.Version.LUCENE_46);
